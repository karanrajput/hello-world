...
class Allcategorydata extends StatefulWidget {
  Allcategorydata({Key key}) : super(key: key);

  @override
  _AllcategorydataState createState() => _AllcategorydataState();
}

class _AllcategorydataState extends State<Allcategorydata> {
